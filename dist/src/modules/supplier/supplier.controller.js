...
let SupplierController = class SupplierController {
    ...
    async createSupplier(orgId, body) {
        return this.supplierService.createSupplier({
            ...body,
            buyerOrgId: orgId,
        });
    }
    async getSuppliersByOrg(orgId) {
...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.RequirePermissions)({ supplier: ['create'] }),
...
__decorate([
    ...
    (0, permissions_decorator_1.RequirePermissions)({ supplier: ['read'] }),
    __param(0, (0, active_org_decorator_1.ActiveOrgId)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SupplierController.prototype, "getSuppliersByOrg", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, permissions_decorator_1.RequirePermissions)({ supplier: ['delete'] }),
